...
<head>
    ...
    <title>Vols - Carré Premium</title>
        ...
        <aside id="sidebar" class="w-64 glass shadow-2xl flex-shrink-0 flex flex-col transition-all duration-300 ease-in-out">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3">
                ...
                <div class="mt-6">
                    ...
                    <a href="{{ route('admin.flights.index') }}" class="sidebar-link flex items-center px-4 py-3 mb-2 rounded-lg active">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="h-16 glass shadow-lg flex items-center justify-between px-4 md:px-6 relative z-30">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-lg md:text-xl font-bold text-gray-800 font-montserrat">Gestion des Vols</h2>

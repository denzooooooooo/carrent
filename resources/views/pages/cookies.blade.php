...
@section('meta_description', 'Découvrez comment Carré Premium utilise les cookies pour faire fonctionner le site, mémoriser vos préférences et sécuriser votre expérience.')
    ...
    <section class="cp-page-hero">
        <div class="cp-shell">
            <div class="cp-panel rounded-[2rem] px-6 py-8 sm:px-8 sm:py-10">
                ...
                <h1 class="mt-3 text-3xl font-black text-[color:var(--cp-plum-950)] sm:text-4xl">{{ $t('Des cookies limités à ce qui fait fonctionner le site et mémoriser vos préférences.', 'Cookies limited to what keeps the site running and remembers your preferences.') }}</h1>

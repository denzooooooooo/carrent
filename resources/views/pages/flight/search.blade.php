    ...
    <div class="bg-[#001F3F] text-white py-6">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('flights.index') }}" class="bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
        ...
        @else
            ...
            <div class="text-center py-16 bg-white rounded-xl border border-gray-200">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('flights.index') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">
